    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/register"
                       element={isLogin ? <BoardRegisterPage userObj={userObj}/> : <Navigate replace to="/auth/signin"/>}/>
                <Route path="/read/:board_idx"
                       element={isLogin ? <BoardReadPage userObj={userObj} boardDTO={boardDTO} setBoardDTO={setBoardDTO}/> :
                           <Navigate replace to="/auth/signin"/>}/>
                <Route path="/modify/:board_idx"
                       element={isLogin ? <BoardModifyPage userObj={userObj} boardDTO={boardDTO} setBoardDTO={setBoardDTO}/> :
                           <Navigate replace to="/auth/signin"/>}/>
            </Routes>
        </>
    );
